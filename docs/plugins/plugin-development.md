...
- `Http`: for performing HTTP requests (see [docs](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/plugins/http-package.md))
...
See [Plugin Authentication](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/features/authentication-plugin-login.md)

## Content Types

Docs for data structures like PlatformVideo your plugin uses to communicate with the GrayJay app.

See [Content Types](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/integrations/content-types.md)

## Example plugin

See the example plugin to better understand the plugin API e.g. `getHome` and `search`.

See [Example Plugin](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/plugins/example-plugin.md)

## Pagination

Plugins use "Pagers" to send paginated data to the GrayJay app.

See [Data Pagers](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/data-pagers.md)

## Script signing

When you deploy your plugin, you'll need to add code signing for security.

See [Script Signing](https://gitlab.tsutsen.org/videostreaming/bluejay/-/blob/master/docs/plugins/script-signing.md)
