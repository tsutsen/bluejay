...
How to actually use the authenticated client is described in the Http package documentation  (See [Package: Http](../plugins/http-package.md)).
...
This behavior can be modified by using custom http clients as described in the http package documentation.
 (See [Package: Http](../plugins/http-package.md))
