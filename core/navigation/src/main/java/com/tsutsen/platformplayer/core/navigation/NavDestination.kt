package com.tsutsen.platformplayer.core.navigation
...
sealed class NavDestination {
    ...
    data class VideoDetail(val url: String, val position: Long? = null, val startMinimized: Boolean = false) : NavDestination()
