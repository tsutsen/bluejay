...
import com.tsutsen.platformplayer.core.database.dao.HistoryDao_Impl
import com.tsutsen.platformplayer.core.database.dao.HomeFeedCacheDao
import com.tsutsen.platformplayer.core.database.dao.HomeFeedCacheDao_Impl
import com.tsutsen.platformplayer.core.database.dao.PlaylistDao
import com.tsutsen.platformplayer.core.database.dao.PlaylistDao_Impl
import com.tsutsen.platformplayer.core.database.dao.QueueDao
import com.tsutsen.platformplayer.core.database.dao.QueueDao_Impl
import com.tsutsen.platformplayer.core.database.dao.SubscriptionDao
import com.tsutsen.platformplayer.core.database.dao.SubscriptionDao_Impl
import kotlin.Lazy
      ...
      public override fun onValidateSchema(connection: SQLiteConnection): RoomOpenDelegate.ValidationResult {
        ...
        if (!_infoQueue.equals(_existingQueue)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |queue(com.tsutsen.platformplayer.core.database.entity.QueueEntity).
              | Expected:
        ...
        if (!_infoHistory.equals(_existingHistory)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |history(com.tsutsen.platformplayer.core.database.entity.HistoryEntity).
              | Expected:
        ...
        if (!_infoPlaylists.equals(_existingPlaylists)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |playlists(com.tsutsen.platformplayer.core.database.entity.PlaylistEntity).
              | Expected:
        ...
        if (!_infoPlaylistVideos.equals(_existingPlaylistVideos)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |playlist_videos(com.tsutsen.platformplayer.core.database.entity.PlaylistVideoEntity).
              | Expected:
        ...
        if (!_infoHomeFeedCache.equals(_existingHomeFeedCache)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |home_feed_cache(com.tsutsen.platformplayer.core.database.entity.HomeFeedCacheEntity).
              | Expected:
        ...
        if (!_infoSubscriptions.equals(_existingSubscriptions)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |subscriptions(com.tsutsen.platformplayer.core.database.entity.SubscriptionEntity).
              | Expected:
