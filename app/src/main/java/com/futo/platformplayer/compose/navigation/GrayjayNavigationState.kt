...
fun rememberGrayjayNavigationState(
    ...
    topLevelRoutes: Set<NavKey> = setOf(Home, Subscriptions, Creators, Sources, Playlists, History, Downloads, Settings, PluginBrowser)
...
/**
 * State holder for Grayjay navigation state.
 *
