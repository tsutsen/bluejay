...
import com.tsutsen.platformplayer.SettingsDev
...
import com.tsutsen.platformplayer.developer.DeveloperEndpoints
    ...
    fun testPlayback(){
        ...
        StateApp.instance.scope.launch(Dispatchers.IO) {
            ...
            StateApp.instance.scope.launch(Dispatchers.Main) {
                ...
                if (videoUrl != null) {
                    mainActivity.navigator.navigate(com.tsutsen.platformplayer.core.navigation.NavDestination.ChannelDetail(videoUrl))
                }
            }
        }
    }
