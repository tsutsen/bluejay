...
import com.tsutsen.platformplayer.encryption.GEncryptionProvider
import com.tsutsen.platformplayer.logging.Logger
import com.tsutsen.platformplayer.models.HistoryVideo
import com.tsutsen.platformplayer.models.Subscription
import com.tsutsen.platformplayer.sToOffsetDateTimeUTC
import com.tsutsen.platformplayer.smartMerge
...
import com.tsutsen.platformplayer.stores.StringStringMapStorage
import com.tsutsen.platformplayer.stores.StringTMapStorage
import com.tsutsen.platformplayer.sync.SyncSessionData
import com.tsutsen.platformplayer.sync.internal.GJSyncOpcodes
import com.tsutsen.platformplayer.sync.internal.ISyncDatabaseProvider
import com.tsutsen.platformplayer.sync.internal.Opcode
import com.tsutsen.platformplayer.sync.internal.SyncKeyPair
import com.tsutsen.platformplayer.sync.internal.SyncService
import com.tsutsen.platformplayer.sync.internal.SyncServiceSettings
import com.tsutsen.platformplayer.sync.internal.SyncSession
import com.tsutsen.platformplayer.sync.models.SendToDevicePackage
import com.tsutsen.platformplayer.sync.models.SyncPlaylistsPackage
import com.tsutsen.platformplayer.sync.models.SyncSubscriptionGroupsPackage
import com.tsutsen.platformplayer.sync.models.SyncSubscriptionsPackage
import com.tsutsen.platformplayer.sync.models.SyncWatchLaterPackage
...
class StateSync {
    ...
    companion object {
        val version = 1
        val RELAY_SERVER = "relay.bluejay.app"
