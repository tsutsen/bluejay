...
/**
 * Custom Application class for Bluejay.
...
class App : Application() {
    ...
    companion object {
        ...
        fun applyThemeMode(context: Context) {
            ...
            // The file is stored as com.tsutsen.platformplayer.Settings.json
            val settingsFile = File(context.filesDir, "com.tsutsen.platformplayer.Settings.json")
