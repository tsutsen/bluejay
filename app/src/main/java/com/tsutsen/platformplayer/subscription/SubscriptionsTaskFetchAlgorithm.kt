...
import com.tsutsen.platformplayer.api.media.structures.PlatformContentPager
import com.tsutsen.platformplayer.debug.Stopwatch
...
import com.tsutsen.platformplayer.getNowDiffMiliseconds
...
import com.tsutsen.platformplayer.subsexchange.ChannelRequest
import com.tsutsen.platformplayer.subsexchange.ChannelResolve
import com.tsutsen.platformplayer.subsexchange.ExchangeContract
        ...
        try {
            for(clientTasks in tasksGrouped) {
                ...
                val isSubscriptionsActive = StateApp.instance.contextOrNull?.let { ctx ->
                    (ctx as? MainActivity)?.navigator?.currentRoute?.value is com.tsutsen.platformplayer.core.navigation.NavDestination.Subscriptions
                } == true
