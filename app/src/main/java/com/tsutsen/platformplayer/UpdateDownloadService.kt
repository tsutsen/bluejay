...
import com.tsutsen.platformplayer.states.SessionAnnouncement
import com.tsutsen.platformplayer.states.StateAnnouncement
import com.tsutsen.platformplayer.states.StateUpdate
...
class UpdateDownloadService : Service() {
    ...
    private fun onDownloadComplete(version: Int, apkFile: File) {
        ...
        try {
            ...
            StateAnnouncement.instance.registerAnnouncement("install-update-apk", "Bluejay v${version} is ready!", "You can now install the new Bluejay version.", AnnouncementType.SESSION, OffsetDateTime.now(), "update", "Install") {
