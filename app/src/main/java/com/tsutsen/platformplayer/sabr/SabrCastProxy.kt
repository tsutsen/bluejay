...
class SabrCastProxy(
    ...
    private val sessionListener = object : SabrSessionListener {
        override fun onLiveMetadata(metadata: com.tsutsen.platformplayer.sabr.proto.LiveMetadata) {
            planner.onLiveEdge(metadata.headSequenceNumber)
        }
        override fun onFormatInitialization(metadata: com.tsutsen.platformplayer.sabr.proto.FormatInitializationMetadata) {}
